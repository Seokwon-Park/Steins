...
void Sandbox2D::OnUpdate(Steins::Timestep dt)
{
...

	{
		...
		Steins::Renderer2D::DrawQuad({ -1.0f,0.0f, -.05f }, { .8f,.8f }, { 0.8f, 0.2f, 0.3f, 1.0f });
		Steins::Renderer2D::DrawQuad({ 0.5f,-0.5f }, { .5f,0.75f }, { 0.2f, 0.3f, 0.8f, 1.0f });
		Steins::Renderer2D::DrawQuad({ -5.0f,-5.0f, -.1f }, { 10.0f,10.0f }, m_CheckerboardTexture, 10.0f);
		Steins::Renderer2D::DrawQuad({ -0.5f,-0.5f }, { 1.0f,1.0f }, m_CheckerboardTexture, 20.0f);
