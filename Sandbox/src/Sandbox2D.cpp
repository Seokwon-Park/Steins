...
void Sandbox2D::OnAttach()
{
	...
	//m_CheckerboardTexture = Steins::Texture2D::Create("assets/textures/Logo.png");
}
...
void Sandbox2D::OnUpdate(Steins::Timestep dt)
{
...

	{
		...
		Steins::Renderer2D::DrawQuad({ -5.0f,-5.0f , -0.05f }, { 10.0f,10.0f }, m_CheckerboardTexture, 10.0f);
		//Steins::Renderer2D::DrawQuad({ -0.5f,-0.5f , -0.05f }, { 1.0f,1.0f }, m_CheckerboardTexture, 20.0f);
